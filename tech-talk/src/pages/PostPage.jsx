      ...
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-white rounded-xl shadow-md border-l-4 border-[#820000] p-6 mb-4">
          <div className="flex justify-between items-start gap-3 mb-3">
            <h2 className="text-lg font-bold text-gray-900 flex-1">{post.title}</h2>
            <span className="bg-[#820000] text-white px-3 py-1 rounded-lg text-xs font-semibold whitespace-nowrap">{post.community?.name}</span>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
          ...
          <div className="mb-4 pb-4">
            <textarea
              className="w-full text-sm bg-white border border-gray-200 rounded-2xl p-4 mb-2 resize-none text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#820000] focus:border-[#820000]"
              rows={2}
